...
function statusLabel(value) { const status = String(value || '').trim().toLowerCase(); const labels = { pending: 'รอดำเนินการ', submit: 'รอดำเนินการ', review: 'รอดำเนินการ', approved: 'อนุมัติแล้ว', verified: 'ตรวจสอบแล้ว', paid: 'ชำระแล้ว', rejected: 'ปฏิเสธแล้ว', cancelled: 'ยกเลิกแล้ว', unpaid: 'ยังไม่ชำระ' }; return labels[status] || String(value || 'ไม่ระบุ'); }
